                              ...
                              do {
                                 if (
                                    ...
                                    this.dropdownEl.children[s] &&
                                       -1 !==
                                          this.dropdownEl.children[s].tabIndex)
                                 ) {
                                    o = !0;
                                    break;
                                 }
                              ...
                              var r = this.filterQuery.join(""),
                                 l = h(this.dropdownEl)
                                    ...
                                    .filter(function (t) {
                                       return (
                                          0 ===
                                          h(t).text().toLowerCase().indexOf(r)
                                       );
                                    })[0];
                              l &&
                           ...
                           this._setTabsAndTabWidth(),
                              0 !== this.tabWidth &&
                                 ...
                                 ((this._indicator.style.left =
                                    this._calcLeftPos(this.$activeTabLink) +
                                    "px"),
                              ...
                              setTimeout(function () {
                                 (t._indicator.style.left =
                                    ...
                                    (t._indicator.style.right =
                                       t._calcRightPos(t.$activeTabLink) +
                                       "px");
                              }, 0);
                        },
                     },
                        ...
                        value: function () {
                           (c._visibleElements = c._visibleElements.filter(
                              ...
                              ? (o(
                                ...
                                this.id <
                                   c._visibleElements[0][0].M_ScrollSpy.id
                        ...
                        value: function (t, e, i) {
                           ...
                           for (var m = !1, g = 0, _ = 0; g < v; g++) {
                              var y = new Date(t, e, g - a + 1),
                                 ...
                                 x =
                                    n.startRange &&
                                    B._compareDates(n.startRange, y),
                                 L =
                                    n.endRange &&
                     ...
                     },
                     {
                        ...
                        value: function (t) {
                           ...
                           if (
                              ...
                              (o =
                                 (-(s =
                                    (n = this.offset - this.center * this.dim) <
                                    0
                                       ? 1
                                       : -1) *
                                    n *
                              ...
                              this.options.fullWidth
                                 ...
                                 : ((l =
                                      "translateX(" +
                                      (this.el.clientWidth - this.itemWidth) /
                                         2 +
                                      "px) "),
                                   (l +=
                                      "translateY(" +
                  ...
                  [
                     ...
                     },
                     {
                        ...
                        value: function () {
                           var t =
                              -7 +
                              parseInt(
                                 s(this.thumb).parent().css("padding-left")
                              ) +
                              "px";
                           e.remove(this.thumb),
                              e({
                     ...
                     },
                     {
                        ...
                        value: function () {
                           ...
                           return (
                              ((parseFloat(this.$el.val()) - i) / (e - i)) * t
                           );
                        },
                     },
                  ],
